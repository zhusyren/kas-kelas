...
function addSiswa($data) {
	...
	$query = mysqli_query($conn, "INSERT INTO siswa VALUES ('', '$nama_siswa', '$jenis_kelamin', '$nim', '$email')");
  	return mysqli_affected_rows($conn);
}
...
function editSiswa($data) {
	...
	$nim = htmlspecialchars($data['nim']);
	$email = htmlspecialchars($data['email']);
	$query = mysqli_query($conn, "UPDATE siswa SET nama_siswa = '$nama_siswa', jenis_kelamin = '$jenis_kelamin', nim = '$nim', email = '$email' WHERE id_siswa = '$id_siswa'");
  	return mysqli_affected_rows($conn);
}
