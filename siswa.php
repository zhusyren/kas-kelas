...
<div class="wrapper">
                              ...
                              <form method="post">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                      <label for="nim<?= $ds['id_siswa']; ?>">nim</label>
                                      <input type="number" name="nim" value="<?= $ds['nim']; ?>" id="nim<?= $ds['id_siswa']; ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 By  2022 By allif.izz..</strong>
    All rights reserved.
